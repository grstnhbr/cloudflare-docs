...
To get started, select a regex-compatible selector in the [Gateway policy builder](/cloudflare-one/traffic-policies/) and click on the icon. You'll see an input field for natural language, such as "any URL starting with /api/v1" or ".com, .net and .app hosts which contain `gooogle` in the host."
